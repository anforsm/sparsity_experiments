...
def extract_segmentation(
    ...
    fragments: Array = open_ds(filename=fragments_file, ds_name=fragments_dataset)
    chunk_shape = fragments.chunk_shape

    total_roi: Roi = fragments.roi
    read_roi = daisy.Roi(offset=(0,) * 3, shape=chunk_shape * fragments.voxel_size)
    ...
    for threshold in thresholds:
        ...
        lut_filename: str = f"seg_hglom_edges_{merge_function}_{int(threshold*1000)}"
